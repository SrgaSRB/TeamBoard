...
const SettingsTeams: React.FC = () => {
    ...
    const [filterTeamName, setFilterTeamName] = useState<string>("");
    const [filterMinUsers, setFilterMinUsers] = useState<number>();
    const [filterMaxUsers, setFilterMaxUsers] = useState<number>();
    const [filterMinProjects, setFilterMinProjects] = useState<number>();
    const [filterMaxProjects, setFilterMaxProjects] = useState<number>();
                ...
                <div className="s-team-wrapper">
                                ...
                                <div className="div-block-18">
                                    <div>
                                        ...
                                        <input className="w-input" maxLength={256} name="field-3" data-name="Field 3" placeholder="Enter number" type="number" id="field-3"
                                            ...
                                            onChange={(e) =>
                                                setFilterMinUsers(e.target.value ? parseInt(e.target.value) : undefined)
                                            }
                                        />
                                    </div>
                                    <div>
                                        <label htmlFor="field-3">Max Users</label>
                                        <input className="text-field-4 w-input" maxLength={256} name="field-3" data-name="Field 3" placeholder="Enter number" type="text" id="field-3"
                                            value={filterMaxUsers}
                                            onChange={(e) =>
                                                setFilterMaxUsers(e.target.value ? parseInt(e.target.value) : undefined)
                                            }
                                        />
                                    </div>
                                </div>
                                <div className="div-block-18">
                                    <div>
                                        ...
                                        <input className="w-input" maxLength={256} name="field-3" data-name="Field 3" placeholder="Enter number" type="number" id="field-3"
                                            ...
                                            onChange={(e) =>
                                                setFilterMinProjects(e.target.value ? parseInt(e.target.value) : undefined)
                                            }
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input className="w-input" maxLength={256} name="field-3" data-name="Field 3" placeholder="Enter number" type="number" id="field-3"
                                            ...
                                            onChange={(e) =>
                                                setFilterMaxProjects(e.target.value ? parseInt(e.target.value) : undefined)
                                            }
                                        />
                                    </div>
                                </div>
                    ...
                    <div className="div-block-14">
                        ...
                        <div className="teams-list">
                            ...
                            {teams
                                .filter((team) => {
                                    const matchesName = team.name.toLowerCase().includes(filterTeamName.toLowerCase());
                                    const matchesUsers = team.memberCount >= (filterMinUsers ?? 0) && team.memberCount <= (filterMaxUsers ?? Infinity);
                                    const matchesProjects = team.projectCount >= (filterMinProjects ?? 0) && team.projectCount <= (filterMaxProjects ?? Infinity);
                                    return matchesName && matchesUsers && matchesProjects;
                                })
                                .map((team) => (
